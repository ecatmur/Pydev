    ...
    public ICompletionProposal[] getCompletions(IScriptConsoleViewer viewer, String commandLine, 
        ...
        if(!showOnlyTemplates){
            ...
            if(consoleCommunication != null){
                ICompletionProposal[] consoleCompletions = consoleCommunication.getCompletions(text, actTok, offset, whatToShow == AbstractCompletionProcessorWithCycling.SHOW_ONLY_CONSOLE_COMPLETIONS);
